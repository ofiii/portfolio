      ...
      <div className="container-custom section-padding pt-24 md:pt-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              With <span className="font-semibold text-gray-900 dark:text-white">4+ years</span> of experience crafting beautiful, 
...
>
  <div className="relative">
    ...
    <motion.div
      className="hidden md:block absolute left-1/2 -translate-x-1/2 -bottom-6 glass-card px-5 py-3 rounded-xl"
      animate={{ y: [0, 5, 0] }}
  ...
  <div className="flex md:hidden flex-wrap justify-center gap-3 mt-8">
    ...
    >
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-gray-900 via-gray-500 to-gray-900 flex items-center justify-center">
          <span className="text-sm">⚛️</span>
        </div>
        <div>
          <p className="text-xs text-gray-500 dark:text-gray-400">Specialist</p>
          <p className="text-xs font-semibold text-gray-900 dark:text-white">React/Next.js</p>
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-xs text-gray-500 dark:text-gray-400">Also Love</p>
          <p className="text-xs font-semibold text-gray-900 dark:text-white">UI/UX Design</p>
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="flex items-center gap-2">
        <span className="text-sm">✨</span>
        <p className="text-xs font-semibold text-gray-900 dark:text-white">4+ Years Experience</p>
      </div>
    </motion.div>
  </div>
</motion.div>
